...
import ComponentMod.MultiProcessors.multiServer;
...
public class efp extends ViewableDigraph {
	...
	public efp() {
		...
		ViewableDigraph expf = new ef("ExpFrame", 10, 20000);
	...
	public void layoutForSimView() {
		...
		((ViewableComponent) withName("ExpFrame")).setPreferredLocation(new Point(55, 15));
