...
class jobSize extends job {
	...
	public boolean equal(entity m) {
		...
		return processing_time == jm.processing_time && size == jm.size;
	}
	...
	public boolean greater_than(entity m) {
		...
		if (super.equal(m))
			...
			return super.greater_than(m);
	}

	public void print() {
		System.out.println("job: " + name + " processing time: " + processing_time + " size: " + size);
	}
