...
import ComponetAntiAirFleet.FleetAntiAirDefense.RedMissile_1_1;
import ComponetAntiAirFleet.FleetAntiAirDefense.WarShip_1_1;
import view.modeling.ViewableDigraph;

public class SimpleTestAntiAirFleet extends ViewableDigraph {
	// Add Default Constructor
	public SimpleTestAntiAirFleet() {
		this("SimpleTestAntiAirFleet");
	}

	public SimpleTestAntiAirFleet(String name) {
		super(name);
