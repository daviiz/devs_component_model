...
import componentASW.platform.Platform;
import componentASW.weapon.Weapon;
...
//add test input ports:
        ...
        ViewableDigraph warship =  new Platform("warship");
        ViewableDigraph submarine =  new Platform("submarine");
        
        ViewableAtomic enviroment =  new Enviroment("enviroment");
        ViewableAtomic damageAssessment =  new DamageAssessment("damageAssessment");
        
        ViewableDigraph decoy_1 =  new Weapon("decoy_1");
        ViewableDigraph decoy_2 =  new Weapon("decoy_2");
        ViewableDigraph decoy_3 =  new Weapon("decoy_3");
        ViewableDigraph decoy_4 =  new Weapon("decoy_4");
        
        ViewableDigraph terpedo_1 =  new Weapon("terpedo_1");
