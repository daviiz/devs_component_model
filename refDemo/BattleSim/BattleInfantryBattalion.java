...
public class BattleInfantryBattalion extends ViewableAtomic {
    ...
    public BattleInfantryBattalion() {
      this("Battalion", 1);
    }

    public BattleInfantryBattalion(String  name,double  Processing_time){
      super(name);
      tempName = name;
      addInport("in1");
      addInport("in2");
    ...
    public message    out( )
    {
      ...
      if((BattleEnemy.state) == true) {
        ...
        else if(count>0)
        {
          if (powerLevel > 10) {
            m.add(makeContent("out1", new doubleEnt(powerLevel)));
//            System.out.println("===== Infantry ReturnPower : "+BattleEnemy.returnPowerLevel);
