...
public class decelerator1 extends realDevs{
...
public decelerator1(String  name,double length,double a1,double a2,double a3,double a4,double a5,double a6,double a7){
    super(name);
...
public decelerator1(){
this("decelerator1",5,-.1,-.11,-.01,-.1,-.01,-.01,-.1);
}
