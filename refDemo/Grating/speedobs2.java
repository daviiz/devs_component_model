...
/*
This model speedobs2 takes threshold as one of the arguments of its constructor. It accepts
...
public class speedobs2 extends ViewableAtomic{
...
protected boolean flag;
  ...
  public speedobs2(){
    this("speedobs2",10); //name and threshold are arguments
}

public speedobs2(String name,double threshold){
   super(name);
   addInport("vin");
   addInport("pin");
   addInport("stop");
