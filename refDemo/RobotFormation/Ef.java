...
public class Ef extends ViewableDigraph {
	...
	public Ef() {
		...
		// ViewableAtomic g = new generator("Generator",100,"EnvironmentInput.txt");
		ViewableAtomic g = new generator("Generator", 100, "./src/StudentProjects/RobotFormation/EnvironmentInput.txt");
	...
	public void layoutForSimView() {
		preferredSize = new Dimension(637, 320);
		((ViewableComponent) withName("Generator")).setPreferredLocation(new Point(270, 122));
		((ViewableComponent) withName("Environment")).setPreferredLocation(new Point(0, 15));
	}
}
