...
public class worldofr1r6 extends ViewableDigraph {
	...
	public void layoutForSimView() {
		preferredSize = new Dimension(1144, 1143);
		((ViewableComponent) withName("Ef")).setPreferredLocation(new Point(24, 25));
		((ViewableComponent) withName("display")).setPreferredLocation(new Point(881, 546));
		((ViewableComponent) withName("Robots")).setPreferredLocation(new Point(18, 356));
	}
}
